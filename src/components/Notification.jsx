...
export default function Notification({ isOpen, onToggle }) {
  ...
  return (
    <div className="notification-wrapper">
      <button className="notification-btn" onClick={onToggle}>
          ...
          >
            ...
            <div className="notification-body">
              ...
              <div className="notification-actions">
                <button className="notification-yes-btn" onClick={handleReschedule}>
                  ✅ Yes, Reschedule
                </button>
                <button className="notification-no-btn" onClick={handleDismiss}>
                  ❌ No, Dismiss
                </button>
              </div>
            </div>
